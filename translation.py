class Translation:
    START_TEXT = """Hai, bot ini bisa kamu gunakan untuk upload file ke telegram. Cukup kirimkan saja direct link, link google drive ataupun link YouTube.
© @YasirUploadBot"""
...
URL | filename | username | password"""
    ...
    DOWNLOAD_START = "Mencoba Mendownload.."
    UPLOAD_START = "Mencoba Mengupload.."
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "I cannot upload files greater than 1.95GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Terimakasih sudah menggunakan bot ini"
